...
const Mainpage = () => {
  ...
  const [
    ...
    setShowConversationAttributesDropdown,
  ] = useState(false);
  const [showCompanyDetailsDropdown, setShowCompanyDetailsDropdown] =
    useState(false);
  ...
  const chatData = [
    ...
    },
    {
      ...
      logo: "/ilogo.png",
      mainmessage:
        "hello how are you? lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos.",
      input:
    ...
    {
      name: "Booking API problem",
      message: "hey, how are you?...",
      time: "45min",
      logo: "/vlogo.png",
      mainmessage: "do you like my work?",
      input:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
    },
  ];
        ...
        <div className="ai_nav">
          <div className="options_ai">
            <h3
              ...
              onClick={() => {
                setShowai(true), setShowdetails(false);
              }}
            >
              AI Copilot
            </h3>
            <h3
              className="option-tab"
              onClick={() => {
                setShowdetails(true), setShowai(false);
              }}
            >
              Details
            </h3>
        ...
        <div className="inbox_container">
          ...
          <div className="chats_container">
            {chatData.map((chat, index) => (
              ...
              >
                {chat.logo && (
                  <img src={chat.logo} alt="logo" className="chat_logo" />
                )}
            ...
            <div className="chat_container_mainpage">
              {send ? (
                <div className="result_output">
                  {Loading ? (
                    <p style={{ textAlign: "center" }} id="loading_text">
                      Seaching for the relevant sources...
                    </p>
                  ) : (
                    <>
                      ...
                      {(sentMessages1["AI Copilot"] || []).map((msg, idx) => (
                        <div className="icon_output">
                          <div
                            key={idx}
                            className="input_message_container_mainpage"
                          >
                            <p>{msg}</p>
                            <img src="/vlogo.png" alt="" id="logo_reply" />
                          </div>
                        </div>
                      ))}
          ...
          {showdetails && (
            <div className="details_container">
              ...
              <button
                id="dropdown_button"
                onClick={() => {
                  setShowUserDataDropdown(!showUserDataDropdown);
                }}
              >
                USER DATA
                <svg
              ...
              <button
                id="dropdown_button"
                onClick={() => {
                  setShowCompanyDetailsDropdown(!showCompanyDetailsDropdown);
                }}
              >
                COMPANY DETAILS
                <svg
              ...
              <button
                id="dropdown_button"
                onClick={() => {
                  setShowSalesforceDropdown(!showSalesforceDropdown);
                }}
              >
                SALESFORCE
                <svg
              ...
              <button
                id="dropdown_button"
                onClick={() => {
                  setShowStripeDropdown(!showStripeDropdown);
                }}
              >
                STRIPE{" "}
                <svg
              ...
              <button
                id="dropdown_button"
                onClick={() => {
                  setShowJiraDropdown(!showJiraDropdown);
                }}
              >
                JIRA FOR TICKETS
                <svg
